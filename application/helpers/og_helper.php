...
if (!function_exists('og_twitter_domain')) {
  /**
   * [og_twitter_site description]
   * @param  [type] $site [description]
   * @return [type]       [description]
   */
  function og_twitter_domain($domain) {
    if (!is_scalar($domain)) return "";
    return "<meta name=\"twitter:domain\" content=\"$domain\"></meta>" . PHP_EOL;
  }
}

if (!function_exists('og_twitter_url')) {
  /**
   * [og_twitter_site description]
   * @param  [type] $site [description]
   * @return [type]       [description]
   */
  function og_twitter_url($url) {
    if (!is_scalar($url)) return "";
    return "<meta name=\"twitter:url\" content=\"$url\"></meta>" . PHP_EOL;
  }
}

if (!function_exists('og_twitter_image')) {
  /**
   * [og_image description]
   * @param  [type] $url [description]
   * @return [type]      [description]
   */
  function og_twitter_image($url) {
    if (!is_scalar($url)) return "";
    return "<meta property=\"twitter:image\" content=\"$url\" />" . PHP_EOL;
  }
}

if (!function_exists('og_twitter_description')) {
  /**
   * [og_description description]
   * @param  [type] $description [description]
   * @return [type]              [description]
   */
  function og_twitter_description($description) {
    if (!is_scalar($description)) return "";
    return "<meta property=\"twitter:description\" content=\"$description\" />" . PHP_EOL;
  }
}

if (!function_exists('og_twitter_title')) {
  /**
   * [og_title description]
   * @param  [type] $title [description]
   * @return [type]        [description]
   */
  function og_twitter_title($title) {
    if (!is_scalar($title)) return "";
    return "<meta name=\"title\" property=\"twitter:title\" content=\"$title\" />" . PHP_EOL;
  }
}
