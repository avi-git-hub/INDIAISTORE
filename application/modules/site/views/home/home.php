...
<section class="hero-banner"> 
    ...
    <?php echo $images[$random_image]['banner_video']; ?>"  data-banner-name="Fursat">
    <a href="https://www.indiaistore.com/Do-More-On-iPad"  data-banner-name="Homepage-banner">
                
                <picture>
                    <source media="(max-width: 768px)"
                        srcset="<?php echo $images[$random_image]['banner_mob_image']; ?>">
                    <source media="(min-width: 769px)"
                        srcset="<?php echo $images[$random_image]['banner_desk_image']; ?>">
                    <img class="mob"
                        src="<?php echo $images[$random_image]['banner_mob_image']; ?>"
                        alt="Homepage-banner">
                    <img class="dex"
                        src="<?php echo $images[$random_image]['banner_desk_image']; ?>"
                        alt="Homepage-banner">
                </picture>
            </a>
        </div>  -->
