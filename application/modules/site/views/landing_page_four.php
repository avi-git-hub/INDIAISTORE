...
*/
      ...
      .image-why_icon_versatile {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_versatile_large.png?1630888990363);
      }
      ...
      .image-ipad_air_2020_camera_icon {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_2020_camera_icon_large.png?1630888990364);
      }
      ...
      .image-cameras_icon_front_camera {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_front_camera_large.png?1630888990364);
      }
      ...
      .image-cameras_icon_rear_camera {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_rear_camera_large.png?1630888990364);
      }
      ...
      .image-cameras {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_large.png?1630888990364);
      }
      ...
      .image-why_icon_portable {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_portable_large.png?1630888990365);
      }
      ...
      .image-ipad_air_gen04_wifi_silver {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_gen04_wifi_silver_large.png?1630888990365);
      }
      ...
      .image-connectivity {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_large.png?1630888990366);
      }
      ...
      .image-connectivity_icon {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_icon_large.png?1630888990367);
      }
      ...
      .image-wifi_icon {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/wifi_icon_large.png);
      }
      ...
      .image-accessories {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/accessories_large.png?1630888990367);
      }
      ...
      .image-ipad_pro_11_gen03_wifi_silver {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_11_gen03_wifi_silver_large.png?1630641122429);
      }
      ...
      .image-hero {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/hero_large.png?1630888990368);
      }
      ...
      .image-bluetooth_keyboard_icon {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/bluetooth_keyboard_icon_large.png?1630888990369);
      }
      ...
      .image-5g_icon {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/5g_icon_large.png?1630888990369);
      }
      ...
      .image-performance {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/performance_large.png?1630888990371);
      }
      ...
      .image-4g_icon {
        ...
        background-size: 92px 68px;
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/4g_icon_large.png?1630888990371);
      }
      ...
      .image-why_icon_powerful {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_powerful_large.png?1630888990372);
      }
      ...
      .image-m1_chip_icon {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/m1_chip_icon_large.png?1630958341937);
      }
      ...
      .image-design_display {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_large.png?1630888990372);
      }
      ...
      .image-flex_apple_care {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_apple_care_large.png?1630888990373);
      }
      ...
      .image-a14_icon {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a14_icon_large.png?1630888990374);
      }
      ...
      .image-ipad_mini_gen06_wifi_space_grey {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_mini_gen06_wifi_space_grey_large.png?1630888990375);
      }
      ...
      .image-ipados_apps {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipados_apps_large.png?1630888990375);
      }
      ...
      .image-magic_keyboard_icon {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/magic_keyboard_icon_large.png?1630888990375);
      }
      ...
      .image-flex_accessories {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_accessories_large.png?1630888990375);
      }
      ...
      .image-a15_icon {
        ...
        background-size: 70px 70px;
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a15_icon_large.png?1630888990376);
      }
      ...
      .image-ipad_pro_2018_camera_icon {
        ...
        background-size: 72px 71px;
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2018_camera_icon_large.png?1630888990376);
      }
	...
	.image-ipad_pro_2020_camera_icon {
        ...
        background-size: 71px 71px;
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2020_camera_icon_large.png?1630958341936);
      }
      ...
      .image-flex_checkmark_apple_care {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_checkmark_apple_care_large.png?1630888990376);
      }
      ...
      .image-design_display_icon_touch_id {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_icon_touch_id_large.png?1630888990377);
      }
      ...
      .image-pencil_icon {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/pencil_icon_large.png?1630888990377);
      }
      ...
      .image-why_icon_easy {
        ...
        background-repeat: no-repeat;
        background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_easy_large.png?1630888990378);
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-pencil_icon {
          ...
          background-size: 79px 7px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/pencil_icon_large_2x.png?1630888990363);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-why_icon_easy {
          ...
          background-size: 48px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_easy_large_2x.png?1630888990364);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-4g_icon {
          ...
          background-size: 92px 68px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/4g_icon_large_2x.png?1630888990364);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-a15_icon {
          ...
          background-size: 70px 70px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a15_icon_large_2x.png?1630888990364);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-cameras_icon_front_camera {
          ...
          background-size: 35px 35px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_front_camera_large_2x.png?1630888990365);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-m1_chip_icon {
          ...
          background-size: 70px 70px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/m1_chip_icon_large_2x.png?1630958341933);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-performance {
          ...
          background-size: 603px 517px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/performance_large_2x.png?1630888990366);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-design_display {
          ...
          background-size: 697px 508px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_large_2x.png?1630888990366);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-ipad_air_2020_camera_icon {
          ...
          background-size: 72px 71px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_2020_camera_icon_large_2x.png?1630888990366);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-ipad_pro_2020_camera_icon {
          ...
          background-size: 71px 71px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2020_camera_icon_large_2x.png?1630958341931);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-flex_apple_care {
          ...
          background-size: 243px 264px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_apple_care_large_2x.png?1630888990366);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-ipad_mini_gen06_wifi_space_grey {
          ...
          background-size: 142px 176px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_mini_gen06_wifi_space_grey_large_2x.png?1630888990367);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-design_display_icon_touch_id {
          ...
          background-size: 26px 42px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_icon_touch_id_large_2x.png?1630888990368);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-5g_icon {
          ...
          background-size: 92px 68px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/5g_icon_large_2x.png?1630888990368);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-connectivity_icon {
          ...
          background-size: 33px 42px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_icon_large_2x.png?1630888990368);
        }
      }
    ...
    @media (-webkit-min-device-pixel-ratio:1.5),
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-wifi_icon {
          ...
          background-size: 52px 42px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/wifi_icon_large_2x.png);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-ipados_apps {
          ...
          background-size: 721px 432px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipados_apps_large_2x.png?1630888990368);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-cameras {
          ...
          background-size: 595px 353px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_large_2x.png?1630888990369);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-magic_keyboard_icon {
          ...
          background-size: 96px 67px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/magic_keyboard_icon_large_2x.png?1630888990369);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-accessories {
          ...
          background-size: 1074px 466px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/accessories_large_2x.png?1630888990369);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-cameras_icon_rear_camera {
          ...
          background-size: 42px 35px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_rear_camera_large_2x.png?1630888990370);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-a14_icon {
          ...
          background-size: 70px 70px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a14_icon_large_2x.png?1630888990370);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-why_icon_portable {
          ...
          background-size: 15px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_portable_large_2x.png?1630888990370);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-hero {
          ...
          background-size: 1307px 986px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/hero_large_2x.png?1630888990371);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-why_icon_versatile {
          ...
          background-size: 44px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_versatile_large_2x.png?1630888990374);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-why_icon_powerful {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_powerful_large_2x.png?1630888990374);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-flex_checkmark_apple_care {
          ...
          background-size: 14px 14px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_checkmark_apple_care_large_2x.png?1630888990374);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-flex_accessories {
          ...
          background-size: 390px 366px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_accessories_large_2x.png?1630888990375);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-ipad_air_gen04_wifi_silver {
          ...
          background-size: 195px 219px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_gen04_wifi_silver_large_2x.png?1630888990375);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-bluetooth_keyboard_icon {
          ...
          background-size: 79px 67px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/bluetooth_keyboard_icon_large_2x.png?1630888990377);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-ipad_pro_2018_camera_icon {
          ...
          background-size: 72px 71px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2018_camera_icon_large_2x.png?1630888990377);
        }
      }
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-connectivity {
          ...
          background-size: 472px 557px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_large_2x.png?1630888990377);
        }
      }
  @media (-webkit-min-device-pixel-ratio:1.5),
      (min-resolution:144dpi),
      ...
      only screen and (min-resolution:1.5dppx) {
        .image-ipad_pro_11_gen03_wifi_silver {
          ...
          background-size: 200px 221px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_11_gen03_wifi_silver_large.png);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-cameras {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_medium.png);
        }
      }
      @media only screen and (max-width:1068px) {
        .image-ipad_pro_11_gen03_wifi_silver {
      ...
      @media only screen and (max-width:1068px) {
        .image-why_icon_easy {
          ...
          background-size: 48px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_easy_medium.png?1630888990364);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-cameras_icon_front_camera {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_front_camera_medium.png?1630888990367);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-ipad_air_2020_camera_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_2020_camera_icon_medium.png?1630888990367);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-ipad_pro_2020_camera_icon {
          ...
          background-size: 51px 51px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2020_camera_icon_medium.png?1630958341924);
        }
      }
	...
	@media only screen and (max-width:1068px) {
        .image-m1_chip_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/m1_chip_icon_medium.png?1630958341936);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-ipados_apps {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipados_apps_medium.png?1630888990367);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-connectivity {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_medium.png?1630888990368);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-why_icon_portable {
          ...
          background-size: 15px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_portable_medium.png?1630888990368);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-4g_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/4g_icon_medium.png?1630888990369);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-a15_icon {
          ...
          background-size: 52px 52px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a15_icon_medium.png?1630888990369);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-cameras_icon_rear_camera {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_rear_camera_medium.png?1630888990371);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-magic_keyboard_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/magic_keyboard_icon_medium.png?1630888990371);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-5g_icon {
          ...
          background-size: 73px 54px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/5g_icon_medium.png?1630888990371);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-why_icon_powerful {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_powerful_medium.png?1630888990372);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-why_icon_versatile {
          ...
          background-size: 44px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_versatile_medium.png?1630888990372);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-accessories {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/accessories_medium.png?1630888990372);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-connectivity_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_icon_medium.png?1630888990372);
        }
      }
       ...
       @media only screen and (max-width:1068px) {
        .image-wifi_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/wifi_icon_medium.png);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-a14_icon {
          ...
          background-size: 52px 52px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a14_icon_medium.png?1630888990373);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-performance {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/performance_medium.png?1630888990373);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-hero {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/hero_medium.png?1630888990373);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-ipad_pro_2018_camera_icon {
          ...
          background-size: 51px 51px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2018_camera_icon_medium.png?1630888990373);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-design_display {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_medium.png?1630888990376);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-bluetooth_keyboard_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/bluetooth_keyboard_icon_medium.png?1630888990376);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-design_display_icon_touch_id {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_icon_touch_id_medium.png?1630888990376);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-flex_checkmark_apple_care {
          ...
          background-size: 14px 14px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_checkmark_apple_care_medium.png?1630888990377);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-ipad_mini_gen06_wifi_space_grey {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_mini_gen06_wifi_space_grey_medium.png?1630888990377);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-ipad_air_gen04_wifi_silver {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_gen04_wifi_silver_medium.png?1630888990377);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-flex_apple_care {
          ...
          background-size: 243px 264px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_apple_care_medium.png?1630888990377);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-flex_accessories {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_accessories_medium.png?1630888990378);
        }
      }
      ...
      @media only screen and (max-width:1068px) {
        .image-pencil_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/pencil_icon_medium.png?1630888990378);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-why_icon_versatile {
          ...
          background-size: 44px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_versatile_medium_2x.png?1630888990364);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-cameras_icon_rear_camera {
          ...
          background-size: 39px 32px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_rear_camera_medium_2x.png?1630888990364);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-connectivity {
          ...
          background-size: 446px 485px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_medium_2x.png?1630888990364);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-design_display {
          ...
          background-size: 572px 419px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_medium_2x.png?1630888990365);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-flex_accessories {
          ...
          background-size: 340px 319px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_accessories_medium_2x.png?1630888990366);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-a15_icon {
          ...
          background-size: 52px 52px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a15_icon_medium_2x.png?1630888990368);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-ipad_mini_gen06_wifi_space_grey {
          ...
          background-size: 120px 149px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_mini_gen06_wifi_space_grey_medium_2x.png?1630888990368);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-cameras_icon_front_camera {
          ...
          background-size: 32px 32px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_front_camera_medium_2x.png?1630888990368);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-why_icon_powerful {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_powerful_medium_2x.png?1630888990368);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-ipad_pro_2018_camera_icon {
          ...
          background-size: 51px 51px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2018_camera_icon_medium_2x.png?1630888990368);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-flex_checkmark_apple_care {
          ...
          background-size: 14px 14px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_checkmark_apple_care_medium_2x.png?1630888990369);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-design_display_icon_touch_id {
          ...
          background-size: 21px 34px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_icon_touch_id_medium_2x.png?1630888990369);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-connectivity_icon {
          ...
          background-size: 27px 34px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_icon_medium_2x.png?1630888990369);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-wifi_icon {
          ...
          background-size: 47px 34px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/wifi_icon_medium_2x.png);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-flex_apple_care {
          ...
          background-size: 243px 264px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_apple_care_medium_2x.png?1630888990371);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-why_icon_easy {
          ...
          background-size: 48px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_easy_medium_2x.png?1630888990371);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-a14_icon {
          ...
          background-size: 52px 52px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a14_icon_medium_2x.png?1630888990371);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-bluetooth_keyboard_icon {
          ...
          background-size: 60px 53px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/bluetooth_keyboard_icon_medium_2x.png?1630888990371);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-5g_icon {
          ...
          background-size: 73px 54px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/5g_icon_medium_2x.png?1630888990372);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-magic_keyboard_icon {
          ...
          background-size: 76px 53px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/magic_keyboard_icon_medium_2x.png?1630888990376);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-performance {
          ...
          background-size: 434px 371px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/performance_medium_2x.png?1630888990376);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-4g_icon {
          ...
          background-size: 73px 54px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/4g_icon_medium_2x.png?1630888990377);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-ipad_air_gen04_wifi_silver {
          ...
          background-size: 169px 190px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_gen04_wifi_silver_medium_2x.png?1630888990377);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-accessories {
          ...
          background-size: 728px 463px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/accessories_medium_2x.png?1630888990377);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-hero {
          ...
          background-size: 960px 721px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/hero_medium_2x.png?1630888990377);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-ipad_air_2020_camera_icon {
          ...
          background-size: 51px 51px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_2020_camera_icon_medium_2x.png?1630888990378);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-ipad_pro_2020_camera_icon {
          ...
          background-size: 51px 51px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2020_camera_icon_medium_2x.png?1630958341927);
        }
      } 
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-pencil_icon {
          ...
          background-size: 59px 6px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/pencil_icon_medium_2x.png?1630888990378);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-ipados_apps {
          ...
          background-size: 476px 287px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipados_apps_medium_2x.png?1630888990378);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-why_icon_portable {
          ...
          background-size: 15px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_portable_medium_2x.png?1630888990378);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-m1_chip_icon {
          ...
          background-size: 52px 52px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/m1_chip_icon_medium_2x.png?1630958341938);
        }
      }
      ...
      only screen and (max-width:1068px) and (min-resolution:144dpi) {
        .image-cameras {
          ...
          background-size: 427px 253px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_medium_2x.png?1630888990378);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-connectivity_icon {
          ...
          background-size: 27px 34px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_icon_small.png?1630888990364);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-m1_chip_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/m1_chip_icon_small.png?1630958341925);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-wifi_icon {
          ...
          background-size: 47px 34px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/wifi_icon_small.png);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-pencil_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/pencil_icon_small.png?1630888990364);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-ipad_mini_gen06_wifi_space_grey {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_mini_gen06_wifi_space_grey_small.png?1630888990365);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-flex_accessories {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_accessories_small.png?1630888990365);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-design_display_icon_touch_id {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_icon_touch_id_small.png?1630888990366);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-flex_checkmark_apple_care {
          ...
          background-size: 14px 14px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_checkmark_apple_care_small.png?1630888990367);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-a14_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a14_icon_small.png?1630888990368);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-bluetooth_keyboard_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/bluetooth_keyboard_icon_small.png?1630888990368);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-cameras {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_small.png?1630888990369);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-ipad_air_2020_camera_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_2020_camera_icon_small.png?1630888990369);
        }
      }
       ...
       @media only screen and (max-width:734px) {
        .image-ipad_pro_2020_camera_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2020_camera_icon_small.png?1630958341935);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-performance {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/performance_small.png?1630888990371);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-ipad_pro_2018_camera_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2018_camera_icon_small.png?1630888990372);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-ipad_air_gen04_wifi_silver {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_gen04_wifi_silver_small.png?1630888990372);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-why_icon_easy {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_easy_small.png?1630888990372);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-a15_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a15_icon_small.png?1630888990372);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-ipados_apps {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipados_apps_small.png?1630888990372);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-design_display {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_small.png?1630888990372);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-flex_apple_care {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_apple_care_small.png?1630888990373);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-connectivity {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_small.png?1630888990373);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-accessories {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/accessories_small.png?1630888990373);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-magic_keyboard_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/magic_keyboard_icon_small.png?1630888990375);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-4g_icon {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/4g_icon_small.png?1630888990375);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-5g_icon {
          ...
          background-size: 58px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/5g_icon_small.png?1630888990376);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-why_icon_portable {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_portable_small.png?1630888990376);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-cameras_icon_rear_camera {
          ...
          background-size: 39px 32px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_rear_camera_small.png?1630888990377);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-cameras_icon_front_camera {
          ...
          background-size: 32px 32px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_front_camera_small.png?1630888990377);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-why_icon_powerful {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_powerful_small.png?1630888990377);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-hero {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/hero_small.png?1630888990378);
        }
      }
      ...
      @media only screen and (max-width:734px) {
        .image-why_icon_versatile {
          ...
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_versatile_small.png?1630888990378);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-connectivity_icon {
          ...
          background-size: 27px 34px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_icon_small_2x.png?1630888990364);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-wifi_icon {
          ...
          background-size: 47px 34px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/wifi_icon_small_2x.png?1630888990364);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-a14_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a14_icon_small_2x.png?1630888990365);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-why_icon_versatile {
          ...
          background-size: 43px 42px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_versatile_small_2x.png?1630888990365);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-why_icon_powerful {
          ...
          background-size: 42px 42px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_powerful_small_2x.png?1630888990365);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-why_icon_easy {
          ...
          background-size: 47px 42px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_easy_small_2x.png?1630888990365);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-ipad_air_gen04_wifi_silver {
          ...
          background-size: 92px 104px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_gen04_wifi_silver_small_2x.png?1630888990366);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-flex_checkmark_apple_care {
          ...
          background-size: 14px 14px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_checkmark_apple_care_small_2x.png?1630888990366);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-bluetooth_keyboard_icon {
          ...
          background-size: 61px 42px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/bluetooth_keyboard_icon_small_2x.png?1630888990366);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-flex_accessories {
          ...
          background-size: 367px 345px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_accessories_small_2x.png?1630888990367);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-5g_icon {
          ...
          background-size: 58px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/5g_icon_small_2x.png?1630888990367);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-hero {
          ...
          background-size: 516px 402px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/hero_small_2x.png?1630888990368);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-ipad_mini_gen06_wifi_space_grey {
          ...
          background-size: 67px 83px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_mini_gen06_wifi_space_grey_small_2x.png?1630888990369);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-design_display {
          ...
          background-size: 564px 331px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_small_2x.png?1630888990369);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-performance {
          ...
          background-size: 360px 308px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/performance_small_2x.png?1630888990369);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-cameras_icon_rear_camera {
          ...
          background-size: 39px 32px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_rear_camera_small_2x.png?1630888990371);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-ipad_pro_2018_camera_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2018_camera_icon_small_2x.png?1630888990373);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-ipados_apps {
          ...
          background-size: 550px 331px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipados_apps_small_2x.png?1630888990373);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-cameras_icon_front_camera {
          ...
          background-size: 32px 32px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_icon_front_camera_small_2x.png?1630888990375);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-cameras {
          ...
          background-size: 341px 204px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/cameras_small_2x.png?1630888990376);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-connectivity {
          ...
          background-size: 296px 350px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/connectivity_small_2x.png?1630888990376);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-m1_chip_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/m1_chip_icon_small_2x.png?1630958341936);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-flex_apple_care {
          ...
          background-size: 219px 237px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/flex_apple_care_small_2x.png?1630888990376);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-pencil_icon {
          ...
          background-size: 61px 6px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/pencil_icon_small_2x.png?1630888990376);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-why_icon_portable {
          ...
          background-size: 14px 42px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/why_icon_portable_small_2x.png?1630888990377);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-4g_icon {
          ...
          background-size: 58px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/4g_icon_small_2x.png?1630888990377);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-ipad_air_2020_camera_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_air_2020_camera_icon_small_2x.png?1630888990377);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-ipad_pro_2020_camera_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/ipad_pro_2020_camera_icon_small_2x.png?1630958341927);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-a15_icon {
          ...
          background-size: 43px 43px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/a15_icon_small_2x.png?1630888990378);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-accessories {
          ...
          background-size: 1048px 372px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/accessories_small_2x.png?1630888990378);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-design_display_icon_touch_id {
          ...
          background-size: 20px 33px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/design_display_icon_touch_id_small_2x.png?1630888990378);
        }
      }
      ...
      only screen and (max-width:734px) and (min-resolution:144dpi) {
        .image-magic_keyboard_icon {
          ...
          background-size: 60px 42px;
          background-repeat: no-repeat;
          background-image: url(https://www.indiaistore.com/files/uploads/landing_pages/ipad_mini/magic_keyboard_icon_small_2x.png?1630888990378);
        }
      }
      ...
      <div class="section i3A9176">
        <div class="section-content">
          <div class="row w7F58B0">
            <div class="column large-12 i298572">
              <div class="row large-display-bleed i8223DF">
                <div class="column b9DD081">
                  <h2 class="visually-hidden-text"> iPad mini <figure aria-hidden="true" class="image image-hero nE61430"></figure>
                  </h2>
                </div>
              </div>
              <div class="row s991E1C">
                <div class="column large-12 yE27922">
                  <p class="copy tEB3933 channel-custom-font-custom-80-headline-super">Mega power. Mini sized.</p>
                  <p class="copy helvetica-neue b8DCBD0 channel-custom-font-custom-24-intro-elevated">All-screen design with Liquid Retina display. Powerful A15&nbsp;Bionic chip. Stay connected with 4G&nbsp;LTE. Now in four&nbsp;beautiful colours. Go from inspiration to creation, anytime,&nbsp;anywhere. </p>
                  <!-- <p class="copy helvetica-neue z294CF3 channel-custom-font-custom-17-body-tight">[Your Message]<br>[Your Message]</p> -->
                  <!--BEGIN CHANNEL-BUTTON-->
                  <!-- <a href="#" aria-label="Buy iPad mini now" class="button button-channel button-base r7A4430"> Buy now </a> -->
                  <!--END CHANNEL-BUTTON-->
                </div>
              </div>
            </div>
      ...
      <!--END > SECTION 1 - HERO -->
      <!--BEGIN > SECTION 2 - DESIGN AND DISPLAY-->
      <div class="section v2EC196">
        <div class="section-content">
          <div class="row s18C4A4">
            <div class="column large-6 medium-5 small-12 small-hide dC42D17">
              <figure aria-label="iPad mini now in four gorgeous colours. Space Grey. Pink. Purple. Starlight." role="img" class="image image-design_display iC401B5"></figure>
            </div>
            <div class="column large-5 large-offset-2 medium-6 small-12 rBA3D0D">
              <h3 class="copy l6AC22F channel-custom-font-custom-24-eyebrow">Design and Display</h3>
              <p class="copy f18C99A channel-custom-font-custom-48-headline">All-screen design. Stunning all around. </p>
              <div class="row large-hide small-show sC0D7E3">
                <div class="column large-12 i160CBF">
                  <figure role="img" class="image image-design_display kE90E74"></figure>
                </div>
              </div>
              <p class="copy helvetica-neue a0FCC83 channel-custom-font-custom-21-intro">Gorgeous all-screen design with an 21.08‑centimetre (8.3-inch) Liquid Retina display that fits in the palm of your hand.<span style="top: -0.2em; position: relative; font-size: .6em;vertical-align: top;" class="">◊</span> And Apple Pencil now attaches magnetically to the side, ready for all those spur-of-the-moment moments.<span style="top: -0.2em; position: relative; font-size: .6em;vertical-align: top;" class="">◊</span></p>
              <div class="row v67A3F8">
                <div class="column large-5 x2D227E">
                  <p class="copy cBC6132 channel-custom-font-custom-32-headline-hero">21.08 cm (8.3″) </p>
                  <p class="copy vD65A22 channel-custom-font-custom-14-caption-reduced">Liquid Retina display</p>
                </div>
                <div class="column large-6 pE2E4F0">
                  <figure aria-hidden="true" class="image image-design_display_icon_touch_id f6EE5EB"></figure>
                  <p class="copy bB6B295 channel-custom-font-custom-14-caption-reduced">Touch ID for secure authentication</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <!--END > SECTION 2 - DESIGN AND DISPLAY-->
      <!--BEGIN > SECTION 3 - PERFORMANCE-->
      <div class="section d4EB33B">
        <div class="section-content">
          <div class="row eC0289A">
            <div class="column large-6 small-12 j774088">
              <h3 class="copy b40EBDC channel-custom-font-custom-24-eyebrow">Performance</h3>
              <p class="copy h7A970A channel-custom-font-custom-48-headline">Small is the new powerful.</p>
              <p class="copy helvetica-neue pE7A1C5 channel-custom-font-custom-21-intro">Faster performance. The new A15 Bionic chip and all-day battery life let you work, create and play wherever life takes you.<span style="top: -0.2em; position: relative; font-size: .6em;vertical-align: top;">◊</span> Edit photos and videos, play graphics‑intensive games and experience unreal AR. </p>
            </div>
            <div class="column large-6 small-12 r1963F7">
              <figure aria-label="iPad mini with the powerful A15 Bionic chip lets you easily edit video projects." role="img" class="image image-performance f69891B"></figure>
            </div>
          </div>
        </div>
      </div>
      <!--END > SECTION 3 - PERFORMANCE-->
      <!--BEGIN > SECTION 4 - CONNECTIVITY-->
      <div class="section rC2B311">
        <div class="section-content">
          <div class="row small-display-bleed t1E98EA">
            <div class="column large-6 small-12 small-hide w57CDB5">
              <figure aria-label="Download and upload multiple files at the same time." role="img" class="image image-connectivity rB9C370"></figure>
            </div>
            <div class="column large-5 medium-5 small-12 x692A8C">
              <h3 class="copy c8620A9 channel-custom-font-custom-24-eyebrow">Connectivity</h3>
              <p class="copy eAFAAB8 channel-custom-font-custom-48-headline">Upload. Download. On the road.</p>
              <p class="copy helvetica-neue aE40C30 channel-custom-font-custom-21-intro">Stay connected with 4G LTE, Wi-Fi 6 and USB-C. So you can FaceTime, stream, game and collaborate. <span style="top: -0.2em; position: relative; font-size: .6em;vertical-align: top;">◊</span> </p>
              <div class="row p80B50E">
                <div class="column large-4 medium-6 mB4EAD9">
                <figure aria-hidden="true" class="image image-wifi_icon qAE3995"></figure>
                  <p class="copy x1C04F2 channel-custom-font-custom-14-caption-reduced">Wi-Fi 6 and &nbsp;4G LTE</p>
                </div>
                <div class="column large-5 medium-6 mB4EAD9">
                  <figure aria-hidden="true" class="image image-connectivity_icon qAE3995"></figure>
                  <p class="copy x1C04F2 channel-custom-font-custom-14-caption-reduced">USB-C charging and connection</p>
                </div>
              </div>
              <div class="row large-hide medium-hide small-show j7B06B5">
                <div class="column large-12 p9366A0">
                  <figure role="img" class="image image-connectivity mFDBDD6"></figure>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="section qBAC1B8">
        <div class="section-content">
          <div class="row c2686E2">
            <div class="column large-6 small-12 y0509A4">
              <h3 class="copy s934CA2 channel-custom-font-custom-24-eyebrow">Cameras</h3>
              <p class="copy p3DE56F channel-custom-font-custom-48-headline">Ultra Wide camera. Ultra-fun possibilities. </p>
              <div class="row large-display-bleed large-hide medium-display-bleed medium-hide small-show v44A9D2">
                <div class="column large-12 g1705AA">
                  <figure role="img" class="image image-cameras p5F1296"></figure>
                </div>
              </div>
              <p class="copy helvetica-neue eC4A5FB channel-custom-font-custom-21-intro">Enjoy more natural video calls with the 12MP Ultra Wide front camera and Centre Stage. Shoot vivid photos, record 4K video or scan a document with the 12MP Wide back camera. </p>
              <div class="row xD0AF9E">
                ...
                <div class="column large-6 small-7 n70915A">
                  <p class="copy helvetica-neue o4C6B65 channel-custom-font-custom-17-body-caption">Front camera with Centre Stage</p>
                </div>
              </div>
              <div class="row t325549">
                ...
                <div class="column large-7 small-9 d904E45">
                  <p class="copy helvetica-neue zB7CCB9 channel-custom-font-custom-17-body-caption">Back camera with <br>True Tone flash</p>
                </div>
              </div>
            </div>
            <div class="column large-6 small-12 small-hide l91E2C5">
              <figure aria-label="Center Stage keeps you in the middle of the frame during video calls." role="img" class="image image-cameras xE3035D"></figure>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="section p7049A1">
        <div class="section-content">
          <div class="row small-display-bleed l3C6B36">
            <div class="column large-6 medium-6 small-12 small-hide g1B5C24">
              <figure aria-label="Draw on iPad mini with the second-generation Apple Pencil, and the Smart Folio protects and folds into a stand." role="img" class="image image-accessories xFD0217"></figure>
            </div>
            <div class="column large-4 medium-5 small-12 m745DB0">
              <h3 class="copy o9EA4FB channel-custom-font-custom-24-eyebrow">Accessories</h3>
              <p class="copy rAACA99 channel-custom-font-custom-48-headline">Apple Pencil. Smart&nbsp;Folio. Everyday essentials. </p>
              <p class="copy helvetica-neue iABC0C1 channel-custom-font-custom-21-intro">iPad mini now supports the second-generation Apple Pencil, which attaches magnetically and charges wirelessly. And a colourful Smart Folio protects iPad mini and folds into a stand.<span style="top: -0.2em; position: relative; font-size: .6em;vertical-align: top;">◊</span> </p>
              <div class="row large-hide small-show dBF5604">
                <div class="column large-12 lAB50CB">
                  <figure role="img" class="image image-accessories b19AC11"></figure>
                </div>
              </div>
            </div>
          </div>
      ...
      <!--BEGIN > SECTION 7 - IPADOS AND APPS-->
      <div class="section b5512A0">
        <div class="section-content">
          <div class="row h2608B3">
            <div class="column large-6 small-12 l6D7B9E">
              <h3 class="copy aE68B57 channel-custom-font-custom-24-eyebrow">iPadOS and Apps</h3>
              <p class="copy w6C79EA channel-custom-font-custom-48-headline">Work wonders with ease.</p>
              <div class="row large-display-bleed large-hide medium-display-bleed medium-hide small-display-bleed small-show h9D9AC6">
                <div class="column large-12 kE98B91">
                  <figure role="img" class="image image-ipados_apps z05820B"></figure>
                </div>
              </div>
              <p class="copy helvetica-neue x521B2D channel-custom-font-custom-21-intro">iPadOS is powerful and easy to use right out of the box. And with over a million apps on the App Store designed just for iPad, you’ll find the right app for anything you want to do.<span style="top: -0.2em; position: relative; font-size: .6em;vertical-align: top;">◊</span> </p>
            </div>
            <div class="column large-6 small-12 small-hide yF750C2">
              <figure aria-label="Use multiple apps at the same time on iPad mini like leaving notes on maps or annotating documents." role="img" class="image image-ipados_apps bFD0276"></figure>
            </div>
          </div>
        </div>
      </div>
      <!--END > SECTION 7 - IPADOS AND APPS-->
      <!--BEGIN > FLEX 8 - WHY IPAD-->
      <div class="section w6c736d">
        <div class="section-content">
          <div class="row large-display-bleed medium-display-bleed q0a3e94">
            <div class="column large-12 q02c985">
              <h3 class="copy f89a263 channel-custom-font-custom-21-eyebrow-reduced">Why iPad</h3>
              <p class="copy a0c7426 channel-custom-font-custom-40-headline-reduced">There’s nothing quite like iPad.</p>
            </div>
            <div class="column large-3 small-6 ecd1114">
              <figure aria-hidden="true" class="image image-why_icon_easy w6189bf"></figure>
              <h4 class="copy helvetica-neue s2fd10f channel-custom-font-custom-17-body-reduced-flex-subhead">Easy to use</h4>
              <p class="copy helvetica-neue z9a22cb channel-custom-font-custom-17-body-reduced-flex">iPad lets you do everything in powerful yet simple ways on the large Multi-Touch display.</p>
            </div>
            <div class="column large-3 small-6 c3c737c">
              <figure aria-hidden="true" class="image image-why_icon_powerful x7471c6"></figure>
              <h4 class="copy helvetica-neue q05c363 channel-custom-font-custom-17-body-reduced-flex-subhead">Powerful</h4>
              <p class="copy helvetica-neue t3cf362 channel-custom-font-custom-17-body-reduced-flex">Run apps like Microsoft Office, Adobe Photoshop and graphics-intensive games.<span style="top: -0.2em; position: relative; font-size: .6em;vertical-align: top;">◊</span> iPad is ready for anything.</p>
            </div>
            <div class="column large-3 small-6 ec88939">
              <figure aria-hidden="true" class="image image-why_icon_portable t34db34"></figure>
              <h4 class="copy helvetica-neue ea02c4b channel-custom-font-custom-17-body-reduced-flex-subhead">Portable</h4>
              <p class="copy helvetica-neue c8278a9 channel-custom-font-custom-17-body-reduced-flex">Remarkably thin and light with a durable design, fast Wi-Fi and cellular, and all-day battery life.<span style="top: -0.2em; position: relative; font-size: .6em;vertical-align: top;">◊</span> </p>
            </div>
            <div class="column large-3 small-6 e785c67">
              <figure aria-hidden="true" class="image image-why_icon_versatile b58f411"></figure>
              <h4 class="copy helvetica-neue aac2b23 channel-custom-font-custom-17-body-reduced-flex-subhead">Versatile </h4>
              <p class="copy helvetica-neue r1ea13f channel-custom-font-custom-17-body-reduced-flex">It’s your notepad, film studio, scanner, mobile office and canvas when you need one.</p>
            </div>
          </div>
        </div>
      </div>
      <!--END > FLEX 8 - WHY IPAD-->
      <!--BEGIN > FLEX 9 - COMPARE-->
      <div class="section c3669a0">
        <div class="section-content">
          <div class="row large-display-bleed medium-display-bleed u4bd09c">
            <div class="column large-12 q0d85cf">
              <h3 class="copy s2eea35 channel-custom-font-custom-21-eyebrow-reduced">Compare</h3>
              <h3 class="copy y81e5d6 channel-custom-font-custom-40-headline-reduced">Find the right iPad for you.</h3>
            </div>
            <div class="r1293d6">
                    ...
                    <div role="table" aria-label="Compare models" class="compare compare-table with-fullwidthrowheader">
                        ...
                        <div role="row" class="compare-row compare-template-preview-item-default">
                          ...
                          <div role="cell" class="first-child compare-column compare-column-0 product-0">
                            <div class="d378430 embed-image" index="0">
                              <figure role="img" aria-label="iPad Pro 11-in." class="compare-image image-ipad_pro_11_gen03_wifi_silver"></figure>
                            </div>
                          </div>
                              ...
                              <div class="colornav">
                                <div>
                                  <div role="list" aria-label="available colors" class="colornav-items">
                                    ...
                                    <div role="listitem" class="colornav-item">
                                      <figure role="img" aria-label="Green" class="colornav-swatch" style="background-color: rgb(204, 223, 201);"></figure>
                                    </div>
                                    <div role="listitem" class="colornav-item">
                              ...
                              <div class="colornav">
                                <div>
                                  <div role="list" aria-label="available colors" class="colornav-items">
                                    ...
                                    <div role="listitem" class="colornav-item">
                                      <figure role="img" aria-label="Pink" class="colornav-swatch" style="background-color: rgb(232, 209, 207);"></figure>
                                    </div>
                                    <div role="listitem" class="colornav-item">
                      ...
                      <div role="rowgroup" class="compare-section section-buy no-padding-top" usestatic="true">
                        ...
                        <!-- <div role="row" class="compare-row compare-template-preview-item-button">
                          ...
                          <div role="cell" class="first-child compare-column compare-column-0 product-0">
                            <div class="button-container" index="0" productname="iPad Pro 11-in."><a href="#" aria-label="Buy iPad Pro 11-in. (3rd generation)" class="button">Buy now</a></div>
                          </div>
                          <div role="cell" class="compare-column compare-column-1 product-1">
                            <div class="button-container" index="1" productname="iPad Air"><a href="#" aria-label="Buy iPad Air (4th generation)" class="button">Buy now</a></div>
                          </div>
                          <div role="cell" class="compare-column compare-column-2 product-2">
                            <div class="button-container" index="2" productname="iPad mini"><a href="#" aria-label="Buy iPad mini (6th generation)" class="button">Buy now</a></div>
                          </div>
                        </div> -->
                      ...
                      <div role="rowgroup" class="compare-section section-quick-look no-padding-top multi-row" usestatic="true">
                        ...
                        <div role="row" class="compare-row compare-template-preview-item-badge">
                          ...
                          <div role="cell" class="first-child compare-column compare-column-0 product-0">
                            <figure role="presentation" class="badge" index="0">
                              <div class="badge-content">
                                <div class="badge-row">
                                  <!----><span class="badge-value channel-custom-font-custom-32-headline-hero">27.96 cm</span>
                                  <!---->
                                  <!---->
                                </div>
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">(11″) Liquid Retina display<sup>◊&nbsp;</sup>&nbsp;<br>ProMotion technology and True Tone</span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                          ...
                          <div role="cell" class="compare-column compare-column-1 product-1">
                            <figure role="presentation" class="badge" index="1">
                              <div class="badge-content">
                                <div class="badge-row">
                                  <!----><span class="badge-value channel-custom-font-custom-32-headline-hero">27.69 cm</span>
                                  <!---->
                                  <!---->
                                </div>
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">(10.9″) Liquid Retina display<sup>◊&nbsp;</sup>&nbsp;<br>True&nbsp;Tone</span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                          ...
                          <div role="cell" class="compare-column compare-column-2 product-2">
                            <figure role="presentation" class="badge" index="2">
                              <div class="badge-content">
                                <div class="badge-row">
                                  <!----><span class="badge-value channel-custom-font-custom-32-headline-hero">21.08 cm</span>
                                  <!---->
                                  <!---->
                                </div>
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">(8.3″) Liquid Retina display<sup>◊&nbsp;</sup>&nbsp;<br>True&nbsp;Tone</span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                          ...
                          <div role="cell" class="first-child compare-column compare-column-0 product-0">
                            <figure role="presentation" class="badge" index="0">
                              <div class="badge-content">
                                ...
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">M1 chip with next‑generation Neural&nbsp;Engine</span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                          ...
                          <div role="cell" class="compare-column compare-column-1 product-1">
                            <figure role="presentation" class="badge" index="1">
                              <div class="badge-content">
                                ...
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">A14 Bionic chip with Neural Engine</span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                          ...
                          <div role="cell" class="compare-column compare-column-2 product-2">
                            <figure role="presentation" class="badge" index="2">
                              <div class="badge-content">
                                ...
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">A15 Bionic chip with Neural Engine</span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                        ...
                        <!--BEGIN > CATEGORY > QUICK-LOOK > FEATURE > CAPACITY-->
                        <div role="row" class="compare-row compare-template-preview-item-badge">
                          <div role="rowheader" aria-rowspan="0" class="compare-rowheader">
                            <div class="visuallyhidden">Capacity</div>
                          </div>
                          <div role="cell" class="first-child compare-column compare-column-0 product-0">
                            <figure role="presentation" class="badge" index="0">
                              <div class="badge-content">
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">Up to<sup>◊</sup></span>
                                  <!---->
                                  <!---->
                                </div>
                                <div class="badge-row">
                        ...
                        <!--END > CATEGORY > QUICK-LOOK > FEATURE > CAPACITY-->
                          ...
                          <div role="cell" class="first-child compare-column compare-column-0 product-0">
                            <figure role="presentation" class="badge" index="0">
                              <div class="badge-content">
                                ...
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">12MP Wide and 10MP&nbsp;Ultra Wide cameras</span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                          ...
                          <div role="cell" class="compare-column compare-column-1 product-1">
                            <figure role="presentation" class="badge" index="1">
                              <div class="badge-content">
                                ...
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">12MP Wide camera</span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                          ...
                          <div role="cell" class="compare-column compare-column-1 product-1">
                            <figure role="presentation" class="badge" index="1">
                              <div class="badge-content">
                                ...
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">4G LTE cellular<sup>◊</sup></span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                        ...
                        <!--BEGIN > CATEGORY > QUICK-LOOK > FEATURE > PENCIL COMPATIBILITY-->
                        <div role="row" class="compare-row compare-template-preview-item-badge">
                          <div role="rowheader" aria-rowspan="0" class="compare-rowheader">
                            <div class="visuallyhidden">Pencil compatibility</div>
                          </div>
                          <div role="cell" class="first-child compare-column compare-column-0 product-0">
                            <figure role="presentation" class="badge" index="0">
                              <div class="badge-content">
                                ...
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">Works with Apple Pencil (2nd generation)<sup>◊</sup></span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                        ...
                        <!--END > CATEGORY > QUICK-LOOK > FEATURE > PENCIL COMPATIBILITY-->
                        <!--BEGIN > CATEGORY > QUICK-LOOK > FEATURE > KEYBOARD COMPATIBILITY-->
                        <div role="row" class="compare-row compare-template-preview-item-badge">
                          <div role="rowheader" aria-rowspan="0" class="compare-rowheader">
                            <div class="visuallyhidden">Keyboard compatibility</div>
                          </div>
                          <div role="cell" class="first-child compare-column compare-column-0 product-0">
                            <figure role="presentation" class="badge" index="0">
                              <div class="badge-content">
                                ...
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">Works with Magic&nbsp;Keyboard and Smart Keyboard Folio<sup>◊</sup></span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
                          ...
                          <div role="cell" class="compare-column compare-column-2 product-2">
                            <figure role="presentation" class="badge" index="2">
                              <div class="badge-content">
                                ...
                                <div class="badge-row">
                                  <!----><span class="badge-caption copy">Works with Bluetooth&nbsp;keyboards<sup>◊</sup></span>
                                  <!---->
                                  <!---->
                                </div>
                              </div>
      ...
      <!--END > FLEX 9 - COMPARE-->
      <!--BEGIN > FLEX 10 - ACCESSORIES-->
      <div class="section e49985d">
        <div class="section-content">
          <div class="row large-display-bleed medium-display-bleed c60E836">
            <div class="column large-7 small-12 nAFA3F4">
              <h3 class="copy xC7D39D channel-custom-font-custom-21-eyebrow-reduced">Accessories</h3>
              <p class="copy eE0CDA5 channel-custom-font-custom-40-headline-reduced">Do even more with iPad mini.</p>
              <p class="copy helvetica-neue bEA379A channel-custom-font-custom-17-body-reduced">Explore cases, covers, Apple Pencil, AirPods and more.<span style="top: -0.2em; position: relative; font-size: .6em;vertical-align: top;">◊</span></p>
              <!-- <div class="row f018985">
                <div class="column large-12 h012660"><a href="#" class="link-wrapper"><span class="cDAA9C9 icon icon-chevronright icon-after channel-custom-font-custom-17-body-reduced"><span>Shop Apple accessories</span></span></a></div>
              </div> -->
            </div>
            <div class="column large-5 small-12 dC195AF">
              <figure aria-label="Go further iPad mini with accessories like Smart Folio, Apple Pencil (2nd generation) and AirPods." role="img" class="image image-flex_accessories xC1D054"></figure>
            </div>
          </div>
        </div>
      </div>
      <!--END > FLEX 10 - ACCESSORIES-->
      <!--BEGIN > FLEX 11 - APPLE CARE +-->
            ...
            <div class="column large-7 small-12 s2cff78">
              ...
              <div class="row b5eff07">
                <div class="column large-12 dF0A11E">
                  <ul role="list" aria-label="AppleCare+ support and coverage" class="list b3CE396">
                    <li role="listitem" class="list-item g98B663">
                      <div class="row yEF0B8D">
                    ...
                    <li role="listitem" class="list-item d205C33">
                      <div class="row fc0bf7e">
                        ...
                        <div class="column large-11 u47f958">
                          <p class="copy helvetica-neue r11b234 channel-custom-font-custom-17-body-reduced">Priority access to Apple experts</p>
                        </div>
                      </div>
                    </li>
              ...
              <!-- <div class="row c5B8E0C">
                <div class="column large-12 u6E6A4B"><a href="#" class="link-wrapper"><span class="f75E2FF icon icon-chevronright icon-after channel-custom-font-custom-17-body-reduced"><span>Learn more about AppleCare+ for iPad&nbsp;mini</span></span></a></div>
              </div> -->
            </div>
            <div class="column large-5 small-12 x7b6000">
              <figure aria-label="AppleCare+ for iPad mini means enhanced coverage." role="img" class="image image-flex_apple_care t3f263f"></figure>
            </div>
          </div>
        </div>
      </div>
      <!--END > FLEX 11 - APPLE CARE +-->
      <!--BEGIN > LEGAL-->
      <div class="section t8AAAFD">
        <div class="section-content">
          <div class="row large-display-bleed medium-display-bleed f92D625">
            <div class="column large-12 medium-12 zC1A80A">
              <div class="row d44D617">
                <div class="column large-12 r98AB8D">
                  <p class="copy helvetica-neue bF92D2B channel-custom-font-custom-12-sosumi"><span id="footnote-diamond-1">◊</span>Legal Disclaimers</p>
                </div>
              </div>
              <div class="row hB0CE4D">
                <div class="column large-12 s842FBE">
                  <p class="copy helvetica-neue t82A192 channel-custom-font-custom-12-sosumi"><span style="font-weight: 500;">Cellular and Wireless:</span> Data plan is required. 5G, Gigabit LTE, Gigabit-class LTE, 4G LTE Advanced, 4G LTE and Wi-Fi calling are available in selected markets and through selected carriers. Speeds are based on theoretical throughput and vary based on site conditions and carrier. For details on 5G and LTE support, contact your carrier and see <a href="https://www.apple.com/in/ipad/cellular" class="footer-link __nah"><span style="color: #424245"> apple.com/in/ipad/cellular</span></a>.</p>
                </div>
              </div>
              <div class="row gB60A1F">
                <div class="column large-12 uCF0E6A">
                  <p class="copy helvetica-neue n88A9A9 channel-custom-font-custom-12-sosumi"><span style="font-weight: 500;">Display:</span> The displays have rounded corners. When measured diagonally as a rectangle, the iPad Pro 12.9-inch screen is 32.77 centimetres (12.9 inches), the iPad Pro 11-inch screen is 27.96 centimetres (11 inches), the iPad Air (4th generation) screen is 27.59 centimetres (10.86 inches) and the iPad mini (6th generation) screen is 21.08 centimetres (8.3 inches). Actual viewable area is less.</p>
                </div>
              </div>
              <div class="row j792572">
                <div class="column large-12 i6B8B59">
                  <p class="copy helvetica-neue cB3BA80 channel-custom-font-custom-12-sosumi"><span style="font-weight: 500;">Accessories:</span> Accessories are sold separately.</p>
                </div>
              </div>
              <div class="row g67493D">
                <div class="column large-12 hFEA38A">
                  <p class="copy helvetica-neue m475274 channel-custom-font-custom-12-sosumi"><span style="font-weight: 500;">Power and Battery:</span> Battery life varies by use and configuration. See <a href="https://www.apple.com/in/batteries" class="footer-link"><span style="color: #424245">apple.com/in/batteries</span> for more information.</a></p>
                </div>
              </div>
              <div class="row sCBA443">
                <div class="column large-12 fCD103B">
                  <p class="copy helvetica-neue t789021 channel-custom-font-custom-12-sosumi"><span style="font-weight: 500;">FaceTime:</span> FaceTime calling requires a FaceTime-enabled device for the caller and recipient, and a Wi‑Fi connection. Availability over a cellular network depends on carrier policies; data charges may apply.</p>
                </div>
              </div>
              <div class="row g5949C0">
                <div class="column large-12 t2E99CC">
                  <p class="copy helvetica-neue lB9C6BB channel-custom-font-custom-12-sosumi"><span style="font-weight: 500;">SharePlay:</span> Coming late 2021.</p>
                </div>
              </div>
              <div class="row xAACA71">
                <div class="column large-12 e8D1E6F">
                  <p class="copy helvetica-neue e07CBED channel-custom-font-custom-12-sosumi"><span style="font-weight: 500;">App Store:</span> Apps are available on the App Store. Title availability is subject to change.</p>
                </div>
              </div>
              <div class="row yED2A76">
                <div class="column large-12 yA93E50">
                  <p class="copy helvetica-neue bB081C8 channel-custom-font-custom-12-sosumi"><span style="font-weight: 500;">Capacity:</span> Available space is less and varies due to many factors. A standard configuration uses approximately 10GB to 13GB of space (including iPadOS and pre-installed apps) depending on the model and settings. Pre-installed apps use about 4GB, and you can delete these apps and restore them. Storage capacity is subject to change based on software version and may vary by device.</p>
                </div>
              </div>
              <div class="row u74B429">
                <div class="column large-12 h5195DD">
                  <p class="copy helvetica-neue x2911F8 channel-custom-font-custom-12-sosumi"><span style="font-weight: 500;">Feature Availability:</span> Some features may not be available for all countries or all regions. See&nbsp;<a href="https://www.apple.com/in/ios/feature-availability" class="footer-link __nah"><span style="color: #424245" class="">apple.com/in/ios/feature-availability</span></a> for the complete list.</p>
                </div>
              </div>
            </div>
          </div>
