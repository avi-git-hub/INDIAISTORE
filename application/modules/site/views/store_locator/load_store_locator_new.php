<style>
  .pincode-p .form-group:after{content:none !important;}
  .pincode-p input {     background-color: #959595;
...
.pincode-p .form-control::placeholder {
  color: rgba(255, 255, 255, 0.5);
}

.pincode-popup .form-control::placeholder { color:#ffffff;font-weight: 300;font-size:15px;}

:-ms-input-placeholder { /* Internet Explorer 10-11 */
  color: rgba(255, 255, 255, 0.5);
}

.form_inner .form-group:after {
...
.form_inner .pingroup:after{
  color: transparent !important;
  font-size: 0px !important;
}
.nearby_link .nearby_wrapper {
...
.nearby_link_main img{position:relative; top:5px;}
.nearby_link_main .nearby_wrapper a {line-height: 0.3;
}
.sub_btn{margin: 35px;}
@media (max-width: 767px){.sub_btn{margin: 0px;}}
</style>
  ...
  <section class="store_front" id="store_front">
    <div class="form_wrapper">
      <div class="form_state_city">
        ...
        <form name="form_state_city" id="form_state_city" method="post">
          <div class="form_inner">
            <div class="col-md-12">
              <div class="col-md-12">
                <div class="row">
                <div class="col-md-3 pincode-popup">
                    <div class="form-group pingroup">
                    <input name="pincode" type="text" class=" form-control pincode" id="pincode" inputmode="numeric" maxlength="6" placeholder="Enter Pincode">
                    </div>
                  </div>
                  <div class="col-md-1">
                        <p style="color: #FFFFFF;text-align: center;padding-top: 11px;padding-bottom: 11px;"><span>OR</span></p>
                  </div>
                  <div class="col-md-4">
