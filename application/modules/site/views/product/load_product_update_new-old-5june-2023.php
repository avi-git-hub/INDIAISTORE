...
.product-color-deep-purple{background-color:#48404f;}
.product-color-space-black{background-color:#333230;}
...
.new-mrp-discount{
  ...
  .bank-box{margin:0px 8px !important;}
...
.mo-visible{display:block;overflow:hidden;}
}
.mr-3, .mx-3 {
...
font-size: 45px;
    ...
    @media (max-width:767px) {
      .control li.prev{left:0 !important;}
      .control li.next{right:0 !important;}
      /* .control li {top: 76% !important;} */
      .tns-nav-active {background-color: gray;}
...
.bank-box{
  border: 1px solid #000000;
    ...
    #cal-new-price-mrp{margin:5px 0px 0px 0px;}
...
section.product-info .info-panel .price-calculator {
    ...
    .new-price-font p, #cal-new-price-mrp span, .price-small-text{font-size: 11px;
    line-height: 1.6;
    font-family: "SF UI Display",sans-serif;}
    ...
    #new-id-mrp{color: gray !important;;
      font-weight: 500;
    font-size: 18px !important;}
    .new-bank-offer h4{    font-size: 15px;
    line-height: 1.6;
    font-family: "SF UI Display",sans-serif;
    margin-bottom: 0;
    margin-top: 8px;}
...
.emioptiondetails-bg{color:#007bff;text-decoration:underline;}
...
.product-offer-carousel .carousel-control-next, .product-offer-carousel .carousel-control-prev{
  position: absolute;
...
.new-bank-offer{min-height:150px;}
.offer-slide-two .tns-outer .tns-controls {
  top: 90px !important;
}
...
<section class="product-info">
          ...
          <div class="media-fix">
                ...
                <!-- <div class="pnBtn">
                  ...
                  <a class="nextButton">Next</a>
                      ...
                      <div class="stick-ul">
                          <ul>
                            <li class="list-menu-compare"><a href="https://www.indiaistore.com/compare/<?php  echo strtolower($cat_name); ?>" target="_blank">Compare</a></li>
                            <li class="list-menu-store"><a href="https://www.indiaistore.com/store-locator" target="_blank">Find a Store</a></li>
                            </ul>
      ...
      <div class="col-12 col-lg-6 info-panel" id="productdetailsinfo">
        ...
        <div class="price-calculator product" data-product-slug="<?= $prod_data->prod_slug ?>">
          ...
          <div class="new-price-section">
              ...
              <div class="new-product-name"><h2  id="product-name-colour">iPhone 14 Pro (128GB, Deep Purple)</h2></div>
            <div class="row for-up-down-space" id="price-section">
              <div class="col-4 col-sm-4 col-md-4 new-price new-price-font" id="cal-new-price">
                ...
                <p class="cd-of"><a href="#benefitdetails" target="self" data-toggle="modal" data-target="#benefitdetails">Card Offer Details</a></p> 
                </div>
              ...
              <div class="col-5 col-sm-5 col-md-5 new-price-mo new-price-font" id="cal-new-price-mo">
                ...
                <p class="emioptiondetails-bg">
                  <a href="#emioptiondetails" class="emi-op" target="self" data-toggle="modal" data-target="#emioptiondetails">EMI Options</a>
                  </p>
              </div>
 ...
 <!--  Benefit Modal-->
            ...
            <div class="row for-up-down-space1" style="display:none;">
              <div class="col-12 col-sm-12 col-md-12 new-price-mrp new-mrp-discount" id="cal-new-price-mrp" style="display:block !important">
                <h3><span  id="new-id-mrp">MRP - <del>129900</del></span> <span class="get-benefit" id="getbenefitupto"><a href="#benefitdetails" target="self" data-toggle="modal" data-target="#benefitdetails">(Get benefits up to <span id="benefitamount">26000</span>*)</a></span></h3>
                </div>
            </div>
          </div>
      ...
      <div class="container">
        third
              ...
              <div class="get-offer-box" id="priceboxdetails" style="display:none;">
                  <ul>
                    <li>
                      <div class="offer-col-1"><p>MRP</p> </div>
                      <div class="offer-col-2"><p id="prod_mrp">₹79900</p></div>                     
                    </li>
                    ...
                    <li>
                      ...
                      <div class="offer-col-2"><p id="prod_exchange_effective_price_emi">₹42900</p></div>
                    </li> 
                    <li>
                       <div class="offer-col-1">
                          <p>Exchange Effective EMI</p>
                          <!-- <span id="exchangeeffectivepricetexteminew"> <?= $prod_data->prod_exchange_effective_price_text_emi ?></span> -->
                          <span>(After ₹5000* Instant Store Discount + Exchange Bonus up to ₹8000*)<br>(Trade-in value of 20000 is calculated on the exchange value of iPhone 11, 64 GB in good condition*)
</span>
                      </div>
                      <div class="offer-col-2"><p id="prod_exchange_effective_price_emi_new">₹42900</p></div>
                    </li> 
...
<?php if (!empty($product_details_tabs)) : ?>
    ...
    <img src="https://www.indiaistore.com/files/uploads/trade-in/trade-in-new-page-images/upgrader_fest-price.png" alt="FEST" class="mr-3 mt-3" style="min-width: 135px;">
            ...
            <div class="stick-ul"> <ul> <li class="list-menu-compare"><a href="https://stage.indiaistore.com/compare/<?php  echo strtolower($cat_name); ?>" target="_blank">Compare</a></li> 
            <li class="list-menu-store"><a href="https://stage.indiaistore.com/store-locator" target="_blank">Find a Store</a></li> </ul> </div>
            </div>
...
section.toc .terms:not(.more) .term:nth-child(n+3) { display: block !important;
}
</style>