              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="prod_feat_cat_name" id="prod_feat_cat_name" value="<?= set_value('prod_feat_cat_name'); ?>" placeholder="Enter unique name" maxlength="100" minlength="1" required />
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="prod_feat_cat_slug" id="prod_feat_cat_slug" value="<?= set_value('prod_feat_cat_slug'); ?>" placeholder="Category Slug" readonly />
                  ...
                  <div class="form-group">
                    ...
                    <div>
                      <input type="checkbox" name="prod_feat_cat_status"
                             ...
                             value="1" <?= set_checkbox('prod_feat_cat_status', '1', true) ?>>
                    </div>
