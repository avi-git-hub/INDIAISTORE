        ...
        <div class="card">
          ...
          <form role="form" method="post" enctype="multipart/form-data" autocomplete="off" id="frm_tabs_block">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="tb_section_desc" id="tb_section_desc" placeholder="Enter description for the section"></textarea>
                  </div>
                </div>
              </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="tb_section_for" id="tb_section_for">
                      <option value="None" <?= set_select('tb_section_for', 'None'); ?>>None</option>
                      <option value="Category" <?= set_select('tb_section_for', 'Category'); ?>>Category</option>
                      <option value="Product" <?= set_select('tb_section_for', 'Product'); ?>>Product</option>
                    </select>
                  </div>
                </div>
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary" name="btn_submit_form" id="btn_submit_form">Submit</button>
            </div>
          </form>
        </div>
        <!-- /.card -->
