      ...
      <div class="card">
        <div class="card-header bg-dark">
          ...
          <div class="float-right">
            <a href="<?= base_url('admin/stories/add-new') ?>" role="button" class="btn btn-success btn-sm">
                ...
                <?php foreach ($stories as $story) : ?>
                  <tr>
                    ...
                    <td class="text-center m-0">
                      <a href="<?= base_url("admin/stories/edit/$story->id"); ?>" target="_self" role="button" class="btn btn-dark btn-sm" title="Edit banner position">
                        <i class="fa fa-edit"></i>
                      </a>

                      <a href="<?= base_url("admin/stories/$story->id"); ?>" target="_self" role="button" class="btn btn-outline-dark btn-sm" title="List the banners for this position">
                        <i class="fa fa-list"></i>
                      </a>

                      <a href="javascript:void(0)" role="button" class="btn btn-sm btn-danger banner_position_delete_btn" id="story_delete_btn_<?= $story->id ?>" data-record-id="<?= $story->id ?>" data-record-title="<?= $story->story_name ?>" data-toggle="modal" data-target="#story_confirm_delete" title="Delete this banner position">
