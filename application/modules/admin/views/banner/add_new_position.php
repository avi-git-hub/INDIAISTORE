              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" required maxlength="100" class="form-control" name="banner_position_name" id="banner_position_name" value="<?= set_value('banner_position_name'); ?>" maxlength="100" minlength="1" placeholder="Enter unique banner position name" required />
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" required maxlength="100" class="form-control" name="banner_position_slug" id="banner_position_slug" value="<?= set_value('banner_position_slug'); ?>" placeholder="Banner Slug" readonly />
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="checkbox" name="banner_position_status" data-bootstrap-switch data-size="large" data-on-color="success" data-off-color="danger" data-on-text="Active" data-off-text="Inactive" value="1" <?= set_checkbox('banner_position_status', '1', true) ?>>
                    </div>
