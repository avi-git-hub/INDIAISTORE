              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="state_name" id="state_name" value="<?= set_value('state_name', $state->name); ?>" maxlength="50" placeholder="Enter State name" />
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="checkbox" name="state_status" data-bootstrap-switch data-size="large" data-on-color="success" data-off-color="danger" data-on-text="Active" data-off-text="Inactive" value="<?= $state->status ?>" <?= set_checkbox('state_status', $state->status, ($state->status == 1) ? true : false) ?>>
                    </div>
