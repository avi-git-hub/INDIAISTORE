...
<section class="content-header">
    <div class="container-fluid">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Add New Navigation Section</h1>
            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="100" class="form-control" name="nav_section_name" id="nav_section_name" value="<?= set_value('nav_section_name'); ?>" placeholder="Enter unique navigation section name" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" maxlength="100" class="form-control" name="nav_section_slug" id="nav_section_slug" value="<?= set_value('nav_section_slug'); ?>" placeholder="Navigation section slug" readonly>
