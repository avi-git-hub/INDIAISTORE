    ...
    <div class="row">
      <div class="col-sm-12">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Edit PDP Image Set</li>
        </ol>
      </div>
    </div>
        ...
        <div class="card">
          <div class="card-header bg-dark">
            ...
            <div class="float-right">
              <a href="<?= base_url("admin/product/$prod_id/pdp-image-set/$pdp_set_id/edit-display-order") ?>" role="button" class="btn btn-info btn-sm">
          ...
          <form name="frm_pdp_set" id="frm_pdp_set" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <input type="hidden" name="pdp_set_id" value="<?= $pdp_set_id ?>" />
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <select class="form-control for_slug" name="pdp_set_color" id="pdp_set_color" disabled>
                    ...
                    <input type="hidden" name="pdp_set_color_value" value="<?= set_value('pdp_set_color_value') ?>" />
                  </div>
                </div>
              </div>
