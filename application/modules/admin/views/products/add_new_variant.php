                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control for_slug" name="product_color" id="product_color">
                        ...
                        foreach ($selected_features_data['product-color'] as $color) :
                          echo "<option value='$color->feat_slug'", set_select('product_color', $color->feat_slug), ">$color->feat_title</option>";
                        endforeach
                        ?>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control for_slug" name="product_storage" id="product_storage">
                        ...
                        foreach ($selected_features_data['storage-space'] as $storage_space) :
                          echo "<option value='$storage_space->feat_slug'", set_select('product_storage', $storage_space->feat_slug), ">$storage_space->feat_title</option>";
                        endforeach
                        ?>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control for_slug" name="product_screen_size" id="product_screen_size">
                        ...
                        foreach ($selected_features_data['screen-size'] as $screen_size) :
                          echo "<option value='$screen_size->feat_slug'", set_select('product_storage', $screen_size->feat_slug), ">$screen_size->feat_title</option>";
                        endforeach
                        ?>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control for_slug" name="product_processor" id="product_processor">
                        ...
                        foreach ($selected_features_data['processor'] as $processor) :
                          echo "<option value='$processor->feat_slug'", set_select('product_processor', $processor->feat_slug), ">$processor->feat_title</option>";
                        endforeach
                        ?>
                      </select>
              ...
              <div class="row">
                <div class="col-sm-8">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="product_variant_slug" id="product_variant_slug" value="<?= set_value('product_variant_slug') ?>" placeholder="Variant Slug" readonly />
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <div>
                      <input type="checkbox" name="product_variant_status" data-bootstrap-switch data-size="large" data-on-color="success" data-off-color="danger" data-on-text="Active" data-off-text="Inactive" value="1" <?= set_checkbox('product_variant_status', '1', true) ?>>
                    </div>
              ...
              <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="product_mrp" id="product_mrp" value="<?= set_value('product_mrp') ?>" placeholder="MRP" />
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="product_effective_price" id="product_effective_price" value="<?= set_value('product_effective_price') ?>" placeholder="Effective Price" />
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="product_exchange_effective_price" id="product_exchange_effective_price" value="<?= set_value('product_exchange_effective_price') ?>" placeholder="Exchange Effective Price" />
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="product_store_discount" id="product_store_discount" value="<?= set_value('product_store_discount') ?>" placeholder="Store Discount" />
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="product_emi" id="product_emi" value="<?= set_value('product_emi') ?>" placeholder="EMI Per Month" />
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="product_exchange_effective_emi" id="product_exchange_effective_emi" value="<?= set_value('product_exchange_effective_emi'); ?>" placeholder="Product Exchange Effective EMI" />
              ...
              <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="product_net_effective_price" id="product_net_effective_price" value="<?= set_value('product_net_effective_price') ?>" placeholder="Net Effective Price" />
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="product_exchange_price" id="product_exchange_price" value="<?= set_value('product_emi') ?>" placeholder="Exchange Price" />
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="product_exchange_bonus" id="product_exchange_bonus" value="<?= set_value('product_exchange_bonus'); ?>" placeholder="Exchange Bonus" />
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="product_cashback" id="product_cashback" value="<?= set_value('product_cashback') ?>" placeholder="Cashback" />
              ...
              <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control wysiwyg" name="product_emi_options" id="product_emi_options" placeholder="Product EMI Options" ><?= set_value('product_emi_options'); ?></textarea>
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="product_benefit_amount" id="product_benefit_amount" value="<?= set_value('product_benefit_amount') ?>" placeholder="Benefit Amount" />
                ...
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control wysiwyg" name="product_benefit_details" id="product_benefit_details" placeholder="Product Benefit details" ><?= set_value('product_benefit_details'); ?></textarea>
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="product_effective_emi" id="product_effective_emi" placeholder="Product Effective EMI" value="<?= set_value('product_effective_emi'); ?>" />
            ...
            <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control wysiwyg" name="product_effective_emi_description" id="product_effective_emi_description" placeholder="Product Effective EMI Description" ><?= set_value('product_effective_emi_description'); ?></textarea>
            ...
            <div class="row">
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control wysiwyg" name="product_exchange_effective_emi_description" id="product_exchange_effective_emi_description" placeholder="Product Exchange Effective EMI Description" ><?= set_value('product_exchange_effective_emi_description'); ?></textarea>
