                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required maxlength="255" autocomplete="field_name" name="field_name" value="<?= isset($store['name']) ? set_value("field_name", $store['name']) : set_value("field_name"); ?>" class="form-control" id="field_name" placeholder="Enter store name">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for="field_logo" class="form-control-label">Mobile Banner Image</label>

                                        <?php
                                        if (!in_array($store['logo'], ['', null])) :
                                            $file_path = "stores/" . $store['logo'];
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="field_logo">Choose new file</label>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="field_state" name="field_state" class="form-control" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="field_city" name="field_city" class="form-control" required>
                                            <?php
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required minlength="6" maxlength="6" autocomplete="field_pincode" name="field_pincode" value="<?= isset($store['pincode']) ? set_value("field_pincode", $store['pincode']) : set_value("field_pincode"); ?>" class="form-control" id="field_pincode" placeholder="Enter pincode">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea required maxlength="1000" class="form-control" name="field_address" id="field_address" rows="4" placeholder="Enter full address"><?= isset($store['address']) ? set_value("field_address", $store['address']) : set_value("field_address"); ?></textarea>
                                ...
                                <div class="col-sm-4 text-center text-sm-left">
                                    <div class="form-group d-inline-block">
                                        ...
                                        <div>
                                            <input type="checkbox" name="field_is_open" data-bootstrap-switch data-size="large" data-on-color="success" data-off-color="danger" data-on-text="Yes" data-off-text="No" value="<?= set_value('field_is_open', ($store['is_open'] == 'yes' ? 1 : 0)); ?>" <?= set_checkbox('field_is_open', set_value('field_is_open', $store['is_open']), ($store['is_open'] == 'yes') ? true : false) ?>>
                                        </div>
                                    ...
                                    <div class="form-group ml-3 d-inline-block">
                                        ...
                                        <div>
                                            <input type="checkbox" name="field_is_delivering" data-bootstrap-switch data-size="large" data-on-color="success" data-off-color="danger" data-on-text="Yes" data-off-text="No" value="<?= set_value('field_is_delivering', ($store['is_delivering'] == 'yes') ? 1 : 0); ?>" <?= set_checkbox('field_is_delivering', set_value('field_is_delivering', $store['is_delivering']), ($store['is_delivering'] == 'yes') ? true : false) ?>>
                                        </div>
                                    ...
                                    <div class="form-group ml-3 d-inline-block">
                                        ...
                                        <div>
                                            <input type="checkbox" name="field_status" data-bootstrap-switch data-size="large" data-on-color="success" data-off-color="danger" data-on-text="Active" data-off-text="Inactive" value="<?= set_value('field_status', $store['status']); ?>" <?= set_checkbox('field_status', set_value('field_status', $store['status']), ($store['status'] == '1') ? true : false) ?>>
                                        </div>
