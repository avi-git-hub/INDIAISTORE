...
}for(g=0;g<j.length;g++){d(h,j[g])}}},{"./className/add":2,"@marcom/ac-polyfills/Array/prototype.slice":undefined,"@marcom/ac-polyfills/Element/prototype.classList":undefined}],2:[function(b,c,a){var d=b("./contains");
...
return}for(g=0;g<j.length;g++){b(h,j[g])}}},{"./className/remove":5,"@marcom/ac-polyfills/Array/prototype.slice":undefined,"@marcom/ac-polyfills/Element/prototype.classList":undefined}],7:[function(c,d,b){d.exports=function a(f){f=f||window;
if(f===window){return window.scrollY||window.pageYOffset}return f.scrollTop}},{}],8:[function(b,c,a){c.exports=8
},{}],9:[function(b,c,a){c.exports=11},{}],10:[function(b,c,a){c.exports=1},{}],11:[function(b,c,a){c.exports=3
},{}],12:[function(c,d,a){var f=c("./internal/validate");d.exports=function b(g,h){f.insertNode(g,true,"insertBefore");
f.childNode(h,true,"insertBefore");f.hasParentNode(h,"insertBefore");return h.parentNode.insertBefore(g,h)
}},{"./internal/validate":14}],13:[function(b,c,a){var d=b("../isNode");c.exports=function f(h,g){if(!d(h)){return false
}if(typeof g==="number"){return(h.nodeType===g)}return(g.indexOf(h.nodeType)!==-1)
}},{"../isNode":15}],14:[function(g,d,j){var b=g("./isNodeType");var c=g("../COMMENT_NODE");
...
if(!q.parentNode){throw new TypeError(s+": "+r+a)}}}},{"../COMMENT_NODE":8,"../DOCUMENT_FRAGMENT_NODE":9,"../ELEMENT_NODE":10,"../TEXT_NODE":11,"./isNodeType":13}],15:[function(b,c,a){c.exports=function d(f){return !!(f&&f.nodeType)
}},{}],16:[function(b,c,a){c.exports={EventEmitterMicro:b("./ac-event-emitter-micro/EventEmitterMicro")}
},{"./ac-event-emitter-micro/EventEmitterMicro":17}],17:[function(b,c,a){function f(){this._events={}
...
}this._events=null};c.exports=f},{}],18:[function(c,d,b){var a=function(){var h="";
...
}},{}],19:[function(f,d,h){var a=f("./shared/stylePropertyCache");var i=f("./shared/getStyleTestElement");
...
}return c(p,n[m])}}return c(p,false)}},{"./shared/getStyleTestElement":21,"./shared/prefixHelper":22,"./shared/stylePropertyCache":23,"./utils/toCSS":25,"./utils/toDOM":26}],20:[function(d,b,h){var f=d("./getStyleProperty");
...
}},{"./getStyleProperty":19,"./shared/prefixHelper":22,"./shared/stylePropertyCache":23,"./shared/styleValueAvailable":24}],21:[function(c,d,b){var f;
d.exports=function a(){if(!f){f=document.createElement("_")}else{f.style.cssText="";
f.removeAttribute("style")}return f};d.exports.resetElement=function(){f=null}},{}],22:[function(b,d,a){var i=["-webkit-","-moz-","-ms-"];
...
this.dom=[this.dom[j]];this.evt=[this.evt[j]]}};d.exports=new c()},{}],23:[function(b,c,a){c.exports={}
},{}],24:[function(c,b,d){var a=c("./stylePropertyCache");var f=c("./getStyleTestElement");
...
}},{"./getStyleTestElement":21,"./stylePropertyCache":23}],25:[function(c,d,b){var f=/^(webkit|moz|ms)/gi;
...
}},{}],26:[function(b,c,a){var f=/-([a-z])/g;c.exports=function d(h){var g;if(h.toLowerCase()==="float"){return"cssFloat"
}h=h.replace(f,function(j,i){return i.toUpperCase()});if(h.substr(0,2)==="Ms"){h="ms"+h.substring(2)
}return h}},{}],27:[function(c,d,b){var g=c("@marcom/ac-prefixer/getStyleValue");
...
d.exports.original=a},{"@marcom/ac-function/memoize":18,"@marcom/ac-prefixer/getStyleProperty":19,"@marcom/ac-prefixer/getStyleValue":20}],28:[function(b,d,a){var g=b("@marcom/ac-event-emitter-micro").EventEmitterMicro;
...
},{"@marcom/ac-event-emitter-micro":16}],29:[function(c,b,d){var n=c("@marcom/ac-event-emitter-micro").EventEmitterMicro;
...
var m=c("@marcom/ac-classlist/remove");var a="css-sticky";var i=function i(p,o){n.call(this);
...
window.addEventListener("orientationchange",this._updatePlaceholderOffset);if("acStore" in window){window.acStore.getStorefront().then(this._updatePlaceholderOffset);
window.acStore.on("storefrontChange",this._updatePlaceholderOffset)}};i.create=function(p,o){return new i(p,o)
};var l=n.prototype;var f=i.prototype=Object.create(l);i.prototype.constructor=i;
f._featureDetection=function(){var p=j("position","sticky");var o=a;if(!p){o="no-"+o
}h(this.el,o);h(this.placeholder,o)};f._createPlaceholder=function(){this.placeholder=document.createElement("div");
this.placeholder.id=this._selectors.placeholderID;g(this.placeholder,this.el);this._updatePlaceholderOffset()
};f._updatePlaceholderOffset=function(){var o=this.placeholder.offsetTop;o+=document.documentElement.offsetTop+document.body.offsetTop;
if(o!==this._placeholderOffset){this._placeholderOffset=o;this._updatePosition()
}};f._updatePosition=function(){var o=k();if(o>this._placeholderOffset){if(!this.stuck){h(this.el,this._selectors.stuckClassName);
h(this.placeholder,this._selectors.stuckClassName);this.stuck=true;this.trigger("stuck")
}}else{if(this.stuck){m(this.el,this._selectors.stuckClassName);m(this.placeholder,this._selectors.stuckClassName);
this.stuck=false;this.trigger("unstuck")}}};b.exports=i},{"@marcom/ac-classlist/add":1,"@marcom/ac-classlist/remove":6,"@marcom/ac-dom-metrics/getScrollY":7,"@marcom/ac-dom-nodes/insertBefore":12,"@marcom/ac-event-emitter-micro":16,"@marcom/ac-feature/cssPropertyAvailable":27}],30:[function(c,d,b){var h=c("@marcom/ac-jetpack-lib/utils/Page");
var g=c("./components/SimpleSticky");var f={initialize:function a(){this.initializeSticky()
},initializeSticky:function i(){var j=document.querySelector("[data-selector-table]");
if(j){new g(j,{className:"selector-table",stuckClassName:"is-sticking"})}}};h.onPageHeightSettled(function(){f.initialize()
