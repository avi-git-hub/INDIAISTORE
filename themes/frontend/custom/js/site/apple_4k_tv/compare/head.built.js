...
return}for(g=0;g<j.length;g++){b(h,j[g])}}},{"./className/remove":5,"@marcom/ac-polyfills/Array/prototype.slice":"@marcom/ac-polyfills/Array/prototype.slice","@marcom/ac-polyfills/Element/prototype.classList":"@marcom/ac-polyfills/Element/prototype.classList"}],7:[function(b,c,a){c.exports=function d(g){var f;
return function(){if(typeof f==="undefined"){f=g.apply(this,arguments)}return f
}}},{}],8:[function(b,c,a){c.exports={getWindow:function(){return window},getDocument:function(){return document
},getNavigator:function(){return navigator}}},{}],9:[function(c,d,b){var g=c("./helpers/globals");
...
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":8,"@marcom/ac-function/once":7}],10:[function(c,d,b){var g=c("./helpers/globals");
var f=c("@marcom/ac-function/once");function a(){var j=g.getWindow();var h=g.getDocument();
var i=g.getNavigator();return !!(("ontouchstart" in j)||(j.DocumentTouch&&h instanceof j.DocumentTouch)||(i.maxTouchPoints>0)||(i.msMaxTouchPoints>0))
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":8,"@marcom/ac-function/once":7}],11:[function(g,a,s){var j=a.exports={};
...
},{"@marcom/ac-browser":12,"@marcom/ac-feature/svgAvailable":9,"@marcom/ac-feature/touchAvailable":10}],20:[function(c,d,b){c("@marcom/ac-polyfills/Array/prototype.forEach");
...
},{}],35:[function(b,c,a){var f=b("@marcom/ac-headjs");var d=function(){return{initialize:function g(){f.htmlClass();
return this}}}();c.exports=d.initialize()},{"@marcom/ac-headjs":18}],"@marcom/ac-polyfills/Array/from":[function(b,c,a){if(!Array.from){Array.from=(function(){var h=Object.prototype.toString;
...
},{"./Array":"@marcom/ac-polyfills/Array","./CustomEvent":"@marcom/ac-polyfills/CustomEvent","./Date":"@marcom/ac-polyfills/Date","./Element":"@marcom/ac-polyfills/Element","./Function":"@marcom/ac-polyfills/Function","./JSON":"@marcom/ac-polyfills/JSON","./Object":"@marcom/ac-polyfills/Object","./Promise":"@marcom/ac-polyfills/Promise","./String":"@marcom/ac-polyfills/String","./XMLHttpRequest":"@marcom/ac-polyfills/XMLHttpRequest","./console.log":"@marcom/ac-polyfills/console.log","./getComputedStyle":"@marcom/ac-polyfills/getComputedStyle","./html5shiv":"@marcom/ac-polyfills/html5shiv","./matchMedia":"@marcom/ac-polyfills/matchMedia","./performance":"@marcom/ac-polyfills/performance","./requestAnimationFrame":"@marcom/ac-polyfills/requestAnimationFrame"}]},{},[35]);