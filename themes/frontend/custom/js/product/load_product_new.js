  ...
  if (selected_product != "" && selected_color != "") {
    ...
    ajax_call.done(function (response, status) {
      ...
      if (response.status == true) {
        console.log(response.data.product_emi);
        $("#prod_mrp")
          .html(response.data.mrp)
          .closest("li")
          .removeClass("d-none");
        $("#new-id-mrp").html("MRP - " + response.data.mrp);
        ...
        if (response.data.exchange_effective_price != "0") {
          ...
          // $("#prod_mrp,#prod_effective_price,#prod_store_discount").css(
          //   "color",
          //   "#bfbfbf"
          // );
        } else {
          ...
          // $("#cal-new-price").css("display","none");
        ...
        if(response.data.effective_price != "0" && response.data.exchange_effective_price == "0"){
          console.log("TEst"+response.data.effective_price);
          $("#priceboxdetails").css("display","block");
