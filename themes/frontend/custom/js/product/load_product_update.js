  ...
  if (selected_product != "" && selected_color != "") {
    ...
    if(selected_product == 'iphone-14-pro'){
      if(selected_storage == '128gb'){
         ...
         $("#exchangeeffectivepricetext").html('(After ₹3000* Cashback + Exchange Bonus up to ₹3000*)<br>(Calculated on exchange value of iPhone 11 64 GB in good condition)'); 
      } else{
        $("#effectivepricetext").html('(After ₹3000* Cashback)');
        $("#exchangeeffectivepricetext").html('(After ₹3000* Cashback + Exchange Bonus up to ₹3000*)<br>(Calculated on exchange value of iPhone 11 64 GB in good condition)'); 
      }
    ...
    ajax_call.done(function (response, status) {
      console.log("Response"+response.data.product_effective_emi);
      if (response.status == true) {
        console.log(response.data.product_exchange_effective_emi);
        $("#prod_mrp")
        ...
        if (response.data.effective_price != "0") {
          ...
          $("#prod_effective_price").closest("li").addClass("d-none");
        ...
        if (response.data.product_emi != "&#8377; 0.00") {
          console.log("2423424");
          $("#cal-new-price-mo-id").html(response.data.product_emi + "/p.m");
          $("#price-section").show();
        } else {
