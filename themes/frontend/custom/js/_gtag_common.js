...
$(document).on("click", ".hamburger-menu li:not(.has-menu) a", function (e) {
  let eventLabel;
  const prod_name = $(this).attr("data-prod-name");
  const menu_name = $(this).attr("data-menu-name");
  if (prod_name) {
...
$(document).on("click", "footer .explore li a", function (e) {
  let eventLabel = "Footer- Explore " + $.trim($(this).text());
  ga("send", {
    hitType: "event",
    eventCategory: "Engagement",
    eventAction: "Click",
...
$(document).on("click", "footer .offers li a", function (e) {
  let eventLabel = "Footer- " + $.trim($(this).text());
  ga("send", {
    hitType: "event",
    eventCategory: "Engagement",
    eventAction: "Click",
...
$(document).on("click", "footer .social-icons li  a", function (e) {
  let eventLabel = "Footer- " + $(this).attr("data-social-name");
  ga("send", {
    hitType: "event",
    eventCategory: "Engagement",
    eventAction: "Click",
...
$(document).on("click", ".floating-wigdet-store", function (e) {
  let eventLabel = "Floating Store Locator Icon";
  ga("send", {
    hitType: "event",
    eventCategory: "Engagement",
    eventAction: "Click",
