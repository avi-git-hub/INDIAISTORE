...
require = function e(b, g, d) {
  ...
  for (var f = 0; f < d.length; f++) {
    ...
    c.exports = { getWindow: function getWindow() {
        return window;
    ...
    var j = a.exports = {};var k;var m;function h() {
      ...
      if (k === setTimeout) {
        ...
        k = setTimeout;return setTimeout(t, 0);
      }try {
        return k(t, 0);
      } catch (u) {
        try {
      ...
      if (m === clearTimeout) {
        ...
        m = clearTimeout;return clearTimeout(t);
      }try {
        return m(t);
      } catch (u) {
        try {
    ...
    var i;var o = -1;function l() {
      ...
      if (r) {
        return;
      }var u = f(l);r = true;var t = n.length;
      while (t) {
        i = n;n = [];while (++o < t) {
          if (i) {
            i[o].run();
    ...
    b("@marcom/ac-polyfills/Array/prototype.some");var d = b("./data");function f() {}f.prototype = { __getBrowserVersion: function __getBrowserVersion(h, i) {
        var g;
        if (!h || !i) {
          return;
      ...
      }, __getName: function __getName(g) {
        return this.__getIdentityStringFromArray(g);
      }, __getIdentity: function __getIdentity(g) {
        if (g.string) {
      ...
      }, __getIdentityStringFromArray: function __getIdentityStringFromArray(g) {
      ...
      }, __getOS: function __getOS(g) {
        return this.__getIdentityStringFromArray(g);
      }, __getOSVersion: function __getOSVersion(i, l) {
        if (!i || !l) {
          return;
      ...
      }, __matchSubString: function __matchSubString(h) {
        var g = h.subString;
        if (g) {
    ...
    c.exports = { getDocumentMode: function getDocumentMode() {
        var d;
    ...
    var i = b("@marcom/ac-object/extend");var c = function c(j, k) {
    ...
    };g.exports = { touch: a, svg: c, ie8: b, "progressive-image": true };
    ...
    var a = Object.prototype.hasOwnProperty;d.exports = function f() {
      ...
      }g = h.shift();h.forEach(function (j) {
        if (j != null) {
          for (var i in j) {
            if (a.call(j, i)) {
              g[i] = j[i];
    ...
    var p = 0;var b = 1;var C = 2;function o(E, J, I, H) {
      ...
      var K,
          J,
          H = I._subscribers,
          G = I._detail;for (var F = 0; F < H.length; F += 3) {
        K = H[F];J = H[F + E];x(E, K, J, G);
      }I._subscribers = null;
    }h.prototype = { constructor: h, _state: undefined, _detail: undefined, _subscribers: undefined, then: function then(J, H) {
        var I = this;
    ...
    h.all = g;h.race = j;h.resolve = l;h.reject = c;function t(I, G) {
      ...
      if (F._state !== m) {
        return;
      }F._state = p;F._detail = E;B.async(y, F);
    }function k(F, E) {
      if (F._state !== m) {
        return;
    ...
    function d(g) {
      if (g && (typeof g === "undefined" ? "undefined" : _typeof(g)) === "object" && g.constructor === this) {
        return g;
      }var f = this;return new f(function (h) {
        h(g);
      });
    }a.resolve = d;
  }, {}], 31: [function (d, f, b) {
    ...
    };b.objectOrFunction = g;b.isFunction = h;
    b.isArray = a;b.now = c;
  }, {}], 32: [function (b, c, a) {
    (function (o, q) {
      ...
      var v;var m = "_html5shiv";var d = 0;var s = {};var i;(function () {
        ...
        var y = n.elements;return typeof y == "string" ? y.split(" ") : y;
      }function t(y, z) {
        var A = n.elements;
        if (typeof A != "string") {
          A = A.join(" ");
        ...
        }C = C || u(A);var D = C.frag.cloneNode(),
            B = 0,
            z = p(),
            y = z.length;
        for (; B < y; B++) {
      ...
      o.html5 = n;f(q);if ((typeof c === "undefined" ? "undefined" : _typeof(c)) == "object" && c.exports) {
        c.exports = n;
      }
    ...
    (function () {
      if (window.matchMedia && window.matchMedia("all").addListener) {
        ...
        var k = i(n),
            m = [],
            l = 0;k.addListener = function (o) {
          if (!d) {
            return;
          }if (!h) {
            h = true;window.addEventListener("resize", f, true);
          }if (l === 0) {
    ...
    window.matchMedia || (window.matchMedia = function () {
      ...
      if (!f) {
        ...
        f = { matchMedium: function matchMedium(i) {
        ...
        return { matches: f.matchMedium(i || "all"), media: i || "all" };
      };
    }());
  }, {}], 35: [function (b, c, a) {
    ...
    c.exports = { browser: [{ name: "edge", userAgent: "Edge", version: ["rv", "Edge"], test: function test(d) {
          return d.ua.indexOf("Edge") > -1 || d.ua === "Mozilla/5.0 (Windows NT 10.0; Win64; x64)";
        } }, { name: "chrome", userAgent: "Chrome" }, { name: "firefox", test: function test(d) {
          return d.ua.indexOf("Firefox") > -1 && d.ua.indexOf("Opera") === -1;
        }, version: "Firefox" }, { name: "android", userAgent: "Android" }, { name: "safari", test: function test(d) {
          return d.ua.indexOf("Safari") > -1 && d.vendor.indexOf("Apple") > -1;
        }, version: "Version" }, { name: "ie", test: function test(d) {
          return d.ua.indexOf("IE") > -1 || d.ua.indexOf("Trident") > -1;
        }, version: ["MSIE", "rv"], parseDocumentMode: function parseDocumentMode() {
          var d = false;if (document.documentMode) {
            d = parseInt(document.documentMode, 10);
          }return d;
        } }, { name: "opera", userAgent: "Opera", version: ["Version", "Opera"] }], os: [{ name: "windows", test: function test(d) {
          return d.platform.indexOf("Win") > -1;
        }, version: "Windows NT" }, { name: "osx", userAgent: "Mac", test: function test(d) {
          return d.platform.indexOf("Mac") > -1;
        } }, { name: "ios", test: function test(d) {
          return d.ua.indexOf("iPhone") > -1 || d.ua.indexOf("iPad") > -1;
        }, version: ["iPhone OS", "CPU OS"] }, { name: "linux", userAgent: "Linux", test: function test(d) {
          return d.platform.indexOf("Linux") > -1 && d.ua.indexOf("Android") === -1;
        } }, { name: "fireos", test: function test(d) {
    ...
    var c = b("./defaults");var h = b("./dictionary");function g(k) {
      ...
      if (typeof n.parseVersion === "function") {
        ...
        var p = n.version || n.userAgent;if (typeof p === "string") {
          p = [p];
        }var o = p.length;
    ...
    if (!Array.from) {
      Array.from = function () {
        ...
        var i = function i(k) {
          ...
          var k = Number(l);if (isNaN(k)) {
            return 0;
          }if (k === 0 || !isFinite(k)) {
            return k;
          }return (k > 0 ? 1 : -1) * Math.floor(Math.abs(k));
        };var f = Math.pow(2, 53) - 1;var d = function d(l) {
          var k = g(l);
    ...
    if (!Array.prototype.forEach) {
      Array.prototype.forEach = function d(l, k) {
        ...
        }var h = this.length;for (f = 0; f < h; f += 1) {
          g = j[f];l.call(k, g, f, j);
        }
      };
    }
    ...
    if (!Array.prototype.lastIndexOf) {
      Array.prototype.lastIndexOf = function a(k, j) {
        var g = Object(this);
        var f = g.length >>> 0;var h;j = parseInt(j, 10);if (f <= 0) {
          return -1;
        }h = typeof j === "number" ? Math.min(f - 1, j) : f - 1;
        h = h >= 0 ? h : f - Math.abs(h);for (; h >= 0; h -= 1) {
          if (h in g && k === g[h]) {
            return h;
          }
        }return -1;
    ...
    if (!Array.prototype.reduce) {
      Array.prototype.reduce = function d(l, h) {
        ...
        var g = j.length >>> 0;var k = 0;var f;if (typeof l !== "function") {
          ...
          if (k in j) {
            f = l.call(undefined, f, j[k], k, j);k += 1;
          }
        }return f;
      };
    }
        ...
        Array.prototype.slice = function (n, j) {
          ...
          if (Object.prototype.toString.call(this) === "[object Array]") {
            return d.call(this, n, j);
              ...
              h = [],
              k,
              g = this.length;var o = n || 0;o = o >= 0 ? o : g + o;var m = j ? j : g;if (j < 0) {
            m = g + j;
          }k = m - o;if (k > 0) {
    ...
    if (!Date.prototype.toJSON) {
      Date.prototype.toJSON = function (h) {
        var i = Object(this);
        var d;var g = function g(j) {
          var l = typeof j === "undefined" ? "undefined" : _typeof(j);var k = [null, "undefined", "boolean", "string", "number"].some(function (m) {
            return m === l;
          });if (k) {
            return true;
          }return false;
        ...
        };d = f(i);if (typeof d === "number" && !isFinite(d)) {
          return null;
        ...
        (function (n) {
          if (!("Element" in n)) {
            ...
            var x = arguments,
                ...
                u;do {
              v = x[w] + "";
              u = k(this, v);while (u !== -1) {
                this.splice(u, 1);s = true;u = k(this, v);
              }
            } while (++w < t);if (s) {
              this._updateClassName();
            }
          };i.toggle = function (t, u) {
            t += "";var s = this.contains(t),
          ...
          f.classList.add("c1", "c2");if (!f.classList.contains("c2")) {
            var g = function g(i) {
              ...
              DOMTokenList.prototype[i] = function (l) {
                var k,
                    j = arguments.length;for (k = 0; k < j; k++) {
                  l = arguments[k];
                  h.call(this, l);
                }
              };
    ...
    if (!Function.prototype.bind) {
      Function.prototype.bind = function (d) {
        ...
        }var i = Array.prototype.slice.call(arguments, 1);var h = this;var f = function f() {};var g = function g() {
    ...
    if (!window.getComputedStyle) {
      ...
      a.prototype = { constructor: a, getPropertyPriority: function getPropertyPriority() {
          throw new Error("NotSupportedError: DOM Exception 9");
        }, getPropertyValue: function getPropertyValue(h) {
          return this[h.replace(/-\w/g, function (i) {
            return i[1].toUpperCase();
          })];
        }, item: function item(h) {
          return this[h];
    ...
    (function () {
      var f = 0;
      var g = ["ms", "moz", "webkit", "o"];for (var d = 0; d < g.length && !window.requestAnimationFrame; ++d) {
        ...
        window.requestAnimationFrame = function (l, i) {
          var h = Date.now();
          var j = Math.max(0, 16 - (h - f));var k = window.setTimeout(function () {
            l(h + j);
          }, j);f = h + j;
          return k;
        };
