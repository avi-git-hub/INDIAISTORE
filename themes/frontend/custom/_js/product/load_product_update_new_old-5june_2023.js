  ...
  if (selected_product != "" && selected_color != "") {
    ...
    if(selected_product == 'iphone-12'){
      if(selected_storage == '64gb'){
         ...
         $("#exchangeeffectivepricetext").html('(After ₹3000* Instant Store Discount + ₹2000* Cashback+ Exchange Bonus up to ₹6000*)<br>(Calculated on exchange value of iPhone 11 64 GB in good condition)'); 
      } else{
        $("#effectivepricetext").html('(After ₹5000* Instant Store Discount + ₹2000* Cashback)');
        $("#exchangeeffectivepricetext").html('(After ₹5000* Instant Store Discount + ₹2000* Cashback + Exchange  Bonus up to ₹6000*)<br>(Calculated on exchange value of iPhone 11 64 GB in good condition)'); 
      }
  }
    ...
    if(selected_product == 'iphone-14-pro'){
      if(selected_storage == '128gb'){
         ...
         $("#exchangeeffectivepricetext").html('(After ₹3000* Cashback + Exchange Bonus up to ₹8000*)<br>(Trade-in value of 26000 is calculated on the exchange value of iPhone 12, 64 GB in good condition*)'); 
      } else{
        $("#effectivepricetext").html('(After ₹3000* Cashback)');
        $("#exchangeeffectivepricetext").html('(After ₹3000* Cashback + Exchange Bonus up to ₹8000*)<br>(Trade-in value of 26000 is calculated on the exchange value of iPhone 12, 64 GB in good condition*)'); 
      }
    ...
    ajax_call.done(function (response, status) {
      ...
      if (response.status == true) {
        console.log(response.data.product_exchange_effective_emi_text);
        $("#prod_mrp_new")
