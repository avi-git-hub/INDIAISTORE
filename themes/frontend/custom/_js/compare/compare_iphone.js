...
$(function () {
  if (query) {
    ...
    products.forEach(function (value, key) {
      $("#product-col-" + (key + 1) + " option").filter(function (i, e) {
  ...
  $(document).on("change", ".product-selector", function (e) {
    var prod1 = $("#product-col-1 option:selected").text();
    var prod2 = $("#product-col-2 option:selected").text();
    var prod3 = $("#product-col-3 option:selected").text();
    ga("send", {
      hitType: "event",
