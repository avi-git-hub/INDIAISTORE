...
$("#banner_confirm_delete").on("click", ".btn-ok", function (e) {
  ...
  var ajax_call = $.ajax({
    ...
    processData: false,
    type: "POST",
    url: "/admin/banner/position/" + position_id + "/delete/" + banner_id,
  });
...
// static event binding
$("#banner_confirm_delete").on("show.bs.modal", function (e) {
